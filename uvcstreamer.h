/*******************************************************************************
#                                                                              #
#      uvcstreamer allows to stream JPG frames from an UVC video camera        #
#      through the HTTP-connection                                             #
#                                                                              #
#      This software based on the mjpeg-streamer                               #
...
#ifndef UVC_STREAMER_H
#define UVC_STREAMER_H

#define SOURCE_NAME 	"uvcstreamer"
...
#define DBG(...) fprintf(stderr, " DBG(%s(), %d): ", __FUNCTION__, __LINE__); fprintf(stderr, __VA_ARGS__)
#else
#define DBG(...)
#endif
